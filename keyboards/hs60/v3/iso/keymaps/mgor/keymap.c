...
// https://beta.docs.qmk.fm/using-qmk/hardware-features/lighting/feature_rgblight
    ...
    #define MG_RGB_VAD KC_TRNS
    #define MG_RGB_VAI KC_TRNS
#endif
...
[_MENU] = LAYOUT_60_iso( /* MENU */
    KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS, \
    KC_TRNS,     MG_RGB_TOG, MG_RGB_RMOD,  MG_RGB_MOD,  MG_RGB_VAD,  MG_RGB_VAI,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  EE_CLR ,     KC_TRNS,  QK_BOOT,           \
    KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS, \
    KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_TRNS,             KC_TRNS, \
    KC_TRNS,     KC_TRNS,    KC_TRNS,                                             KC_TRNS,                                KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS ),
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    if (!layer_state_cmp(state, _BASE)) {
        ...
        if (layer_state_cmp(state, _FUNC)) {
            rgb_matrix_sethsv_noeeprom(MG_LAYER_1_COLOR);
        } else if (layer_state_cmp(state, _CAPS)) {
            rgb_matrix_sethsv_noeeprom(MG_LAYER_2_COLOR);
        } else if (layer_state_cmp(state, _MENU)) {
            rgb_matrix_sethsv_noeeprom(MG_LAYER_3_COLOR);
        }
    } else {
