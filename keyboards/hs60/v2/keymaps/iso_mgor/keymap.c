...
#define MG_CAPS LT(_FL, KC_CAPS)
#define MG_UP RSFT_T(KC_UP)
#define MG_LEFT LT(_FL, KC_LEFT)
#define MG_DOWN MT(KC_RGUI, KC_DOWN)
...
[0] = LAYOUT_60_iso( /* Base */
    ...
    MG_CAPS(2),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,    KC_J,     KC_K,      KC_L,     KC_SCLN,     KC_QUOT,  KC_NUHS,  KC_ENT,  \
    KC_LSFT,     KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,    KC_N,     KC_M,      KC_COMM,  KC_DOT,      KC_SLSH,            MG_UP,   \
    KC_LCTL,     KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MG_LEFT(1),  MG_DOWN,  MG_RIGHT),
...
[2] = LAYOUT_60_iso( /* Empty for dynamic keymaps */
    KC_TRNS,     KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_0,        KC_TRNS,  KC_TRNS,  KC_TRNS,\
