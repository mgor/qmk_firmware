...
[_CAPS] = LAYOUT_60_iso( /* CAPS */
    ...
    KC_TRNS,     KC_PGUP,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_MUTE,  KC_VOLD,     KC_VOLU,  KC_TRNS,          \
    KC_TRNS,     KC_PGDN,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_MPRV,     KC_MPLY,  KC_MNXT,  KC_TRNS,\
    KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_CALC,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_TRNS,            KC_TRNS,\
    KC_TRNS,     KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS),

[_UNUSED] = LAYOUT_60_iso( /* Empty for dynamic keymaps */
