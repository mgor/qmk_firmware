...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MG_FUNC,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
     ...
     */
        ...
        _______, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_VOLD,
        _______, _______, KC_PGDN, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_MUTE,
