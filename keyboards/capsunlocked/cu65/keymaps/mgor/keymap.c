...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
        ...
        _______, _______, KC_HOME, KC_END , _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,          _______,
        _______, _______, ______ , ______ , _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,                   _______,                            _______, _______,          _______, _______, _______
    ),
};
